...
<div id="dashboard-page" data-year="<?= $currentYear ?>" data-month="<?= $currentMonth ?>">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <form method="GET" class="flex space-x-3 bg-white p-1 rounded-lg border border-gray-200 shadow-sm" id="dashboard-filter-form">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Income Card -->
        <div class="relative overflow-hidden rounded-xl shadow-sm border border-emerald-100 bg-gradient-to-br from-emerald-50 to-emerald-100/50 p-6" data-summary="income">
            ...
            <div class="relative">
                ...
                <h2 class="text-3xl font-bold tabular-nums text-gray-900 mb-1" data-value>Rp <?= number_format($summary['total_income'] ?? 0, 0, ',', '.') ?></h2>
                <p class="text-sm text-emerald-700">Total received this month</p>
            </div>
        </div>

        <!-- Total Expenses Card -->
        <div class="relative overflow-hidden rounded-xl shadow-sm border border-red-100 bg-gradient-to-br from-red-50 to-red-100/50 p-6" data-summary="expense">
            ...
            <div class="relative">
                ...
                <h2 class="text-3xl font-bold tabular-nums text-gray-900 mb-1" data-value>Rp <?= number_format($summary['total_expense'] ?? 0, 0, ',', '.') ?></h2>
                <p class="text-sm text-red-700">Total spent this month</p>
            </div>
        </div>

        <!-- Net Balance Card -->
        <div class="relative overflow-hidden rounded-xl shadow-sm border border-blue-100 bg-gradient-to-br from-blue-50 to-blue-100/50 p-6" data-summary="net">
            ...
            <div class="relative">
                ...
                <h2 class="text-3xl font-bold tabular-nums <?= ($summary['net_balance'] ?? 0) >= 0 ? 'text-gray-900' : 'text-red-600' ?> mb-1" data-value>
        ...
        <div class="relative overflow-hidden rounded-xl shadow-sm border border-teal-100 bg-gradient-to-br from-teal-50 to-teal-100/50 p-6" data-summary="total">
            ...
            <div class="relative">
                ...
                <h2 class="text-3xl font-bold tabular-nums text-gray-900 mb-1" data-value>Rp <?= number_format($totalWalletBalance ?? 0, 0, ',', '.') ?></h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="card-custom overflow-hidden">
            ...
            <div id="recent-transactions-container" class="p-0">
        ...
        <div class="card-custom overflow-hidden">
            ...
            <div id="wallet-balances-container" class="p-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card-custom overflow-hidden">
            ...
            <div id="expense-by-category-container" class="p-0">
        ...
        <div class="card-custom overflow-hidden">
            ...
            <div id="income-by-category-container" class="p-0">
...
<script>
    // Initialize charts with PHP data on first load
    (function() {
        Chart.defaults.font.family = "'Inter', sans-serif";
        Chart.defaults.color = '#6B7280';

        // Expense Breakdown Chart
        const ctxBreakdown = document.getElementById('categoryBreakdownChart');
        if (ctxBreakdown) {
            ...
            if (expenseData.length > 0) {
                new Chart(ctxBreakdown, {
                    ...
                    options: {
                        ...
                        cutout: '70%',
                        plugins: {
                            legend: { position: 'bottom', labels: { usePointStyle: true, padding: 15, boxWidth: 8, font: { family: "'Inter', sans-serif", size: 11 } } },
                            tooltip: {
                                backgroundColor: '#1F2937', padding: 12, cornerRadius: 8,
                                callbacks: { label: ctx => ctx.label + ': Rp ' + ctx.parsed.toLocaleString('id-ID') }
                            }
                        }
                    }
                });
            } else {
                ctxBreakdown.parentElement.innerHTML = '<div class="flex flex-col items-center justify-center h-full text-gray-400"><i class="ph ph-chart-pie-slice text-4xl mb-2"></i><span class="text-sm">No expense data available</span></div>';
            }
        }

        // Income Breakdown Chart
        const ctxIncomeBreakdown = document.getElementById('incomeBreakdownChart');
        if (ctxIncomeBreakdown) {
            ...
            if (incomeData.length > 0) {
                ...
                ctxIncomeBreakdown.parentElement.innerHTML = '<div class="flex flex-col items-center justify-center h-full text-gray-400"><i class="ph ph-chart-pie-slice text-4xl mb-2"></i><span class="text-sm">No income data available</span></div>';
            }
        }
                ...
                new Chart(ctxTrend, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: 'Income',
                                data: monthlyTrends.map(item => item.total_income),
                                borderColor: '#10B981',
                            ...
                            {
                                label: 'Expenses',
                                data: monthlyTrends.map(item => item.total_expense),
                                borderColor: '#EF4444',
                    ...
                    options: {
                        ...
                        plugins: {
                            legend: { position: 'top', align: 'end', labels: { usePointStyle: true, boxWidth: 8, font: { family: "'Inter', sans-serif", size: 11 } } },
                            tooltip: {
                                backgroundColor: '#1F2937', padding: 12, cornerRadius: 8,
                        ...
                        scales: {
                            ...
                            x: { grid: { display: false, drawBorder: false }, ticks: { font: { family: "'Inter', sans-serif", size: 10 } } }
                        }
                    }
                });
            } else {
                ctxTrend.parentElement.innerHTML = '<div class="flex flex-col items-center justify-center h-full text-gray-400"><i class="ph ph-chart-line-up text-4xl mb-2"></i><span class="text-sm">No trend data available</span></div>';
            }
        }
    })();
</script>
