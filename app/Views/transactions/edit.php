        ...
        <div class="bg-white rounded-xl shadow-md p-8">
            <form method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 tabular-nums" id="amount" name="amount"
                                   value="<?= htmlspecialchars($_POST['amount'] ?? $transaction['amount'] ?? '') ?>" required placeholder="0">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500" id="notes" name="notes" rows="3" placeholder="Add any additional notes..."><?= htmlspecialchars($_POST['notes'] ?? $transaction['notes'] ?? '') ?></textarea>
                </div>

                <!-- Buttons -->
                <div class="flex gap-4 pt-4">
                    <button type="submit" class="px-8 py-3 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition shadow-md">Update Transaction</button>
